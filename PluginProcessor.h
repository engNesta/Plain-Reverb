...
/**
*/
class PlainReverbAudioProcessor  : public juce::AudioProcessor
...
public:
    //==============================================================================
    PlainReverbAudioProcessor();
    ~PlainReverbAudioProcessor() override;
...
private:
    ...
    //==============================================================================
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (PlainReverbAudioProcessor)
};
